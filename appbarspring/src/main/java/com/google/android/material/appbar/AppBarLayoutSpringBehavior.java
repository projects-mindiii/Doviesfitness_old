...
public class AppBarLayoutSpringBehavior extends AppBarLayout.Behavior {
   ...
   private FinishScroll finishScroll;
    ...
    public AppBarLayoutSpringBehavior(FinishScroll finishScroll) {
    ...
    public boolean onNestedFling(@NonNull CoordinatorLayout coordinatorLayout, @NonNull AppBarLayout child, @NonNull View target, float velocityX, float velocityY, boolean consumed) {
        ...
        if (target instanceof NestedScrollView && velocityY < 0) {
            final NestedScrollView recyclerView = (NestedScrollView) target;
            final View firstChild = recyclerView.getChildAt(0);
            final int childAdapterPosition = 0;
