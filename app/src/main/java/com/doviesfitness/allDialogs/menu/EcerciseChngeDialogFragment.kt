...
class EcerciseChngeDialogFragment : BottomSheetDialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(tag: String): EcerciseChngeDialogFragment {
            val fragment = EcerciseChngeDialogFragment()
            val args = Bundle()
