...
import android.view.MotionEvent
 ...
 open class OnSwipeListener : GestureDetector.SimpleOnGestureListener() {
    ...
    override fun onFling(e1: MotionEvent, e2: MotionEvent, velocityX: Float, velocityY: Float): Boolean {
        ...
        //         / C  \
        //
        // So if (x2,y2) falls india region:
        //  A => it's an UP swipe
    ...
    /**
     * Given two points india the plane p1=(x1, x2) and p2=(y1, y1), this method
    ...
    /**
     * Finds the angle between two points india the plane (x1,y1) and (x2, y2)
    ...
    enum class Direction {
        ...
        companion object {
             ...
             * @return returns true if the given angle is india the interval [init, end).
             */
