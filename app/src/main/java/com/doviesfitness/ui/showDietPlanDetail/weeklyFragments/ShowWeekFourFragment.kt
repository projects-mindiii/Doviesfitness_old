...
import com.doviesfitness.databinding.FragmentWeekFour2Binding
...
class ShowWeekFourFragment : BaseFragment(), ShowDietPlanDetailActivity.WeekFourLinstenr,
    ...
    private lateinit var binding: FragmentWeekFour2Binding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_week_four2, container, false)
        initialization()
        return binding.root
    }
    ...
    private fun initialization() {
        ...
        adapter = ShowWeekAdapter(binding.week4Rv.context, weekPlanList, this)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (showDietPlanDetailActivity != null) {
            showDietPlanDetailActivity.setWeekFourDataListenr(this)
    ...
    override fun getWeekFourData(allWeekData: ShowWorkoutDetailModel.Data.GetProgramWorkouts) {
        weekPlanList.clear()
        val weekFourDataArray = allWeekData.Week4

        if (weekFourDataArray != null) {

            for (i in weekFourDataArray.indices) {
                val weekDataObject = weekFourDataArray.get(i)
    ...
    override fun changeStatus(data: WorkOutListModal.Data, pos: Int, status: String) {
        ...
        if ("UpdateStatus".equals(status)) {
            ...
            intent.putExtra("from_which_frament", "FromWeekFour")
