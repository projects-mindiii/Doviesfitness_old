...
class ShowWeekOneFragment : BaseFragment(), ShowDietPlanDetailActivity.WeekOneLinstenr,
    ...
    private lateinit var binding: com.doviesfitness.databinding.FragmentShowWeekOneBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_show_week_one, container, false)
        initialization()
        return binding.root
    }
    ...
    private fun initialization() {
        ...
        adapter = ShowWeekAdapter(binding.week1Rv.context, weekPlanList, this)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (showDietPlanDetailActivity != null) {
            showDietPlanDetailActivity.setWeekOneDataListenr(this)
    ...
    override fun changeStatus(data: WorkOutListModal.Data, pos: Int, status: String) {
        ...
        if ("UpdateStatus".equals(status)) {
            ...
            intent.putExtra("from_which_frament", "FromWeekOne")
            intent.putExtra("isMyWorkout", "no")
            intent.putExtra("fromDeepLinking", "")
//            intent.putExtra("isalloweduser", isalloweduser)
    ...
    override fun onResume() {
        ...
        isUpdateOrNOt = getDataManager().getUserStringData(AppPreferencesHelper.COMPLETE_WORKOUT_PLAN_STATUS)!!
