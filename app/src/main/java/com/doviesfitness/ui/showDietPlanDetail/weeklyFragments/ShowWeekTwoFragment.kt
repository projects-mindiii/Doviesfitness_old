...
class ShowWeekTwoFragment : BaseFragment(), ShowDietPlanDetailActivity.WeekTwoLinstenr,
    ...
    private lateinit var binding: com.doviesfitness.databinding.FragmentShowWeekTwoBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_show_week_two, container, false)
        initialization()
        return binding.root
    }
    ...
    private fun initialization() {
        ...
        adapter = ShowWeekAdapter(binding.week2Rv.context, weekPlanList, this)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (showDietPlanDetailActivity != null) {
            showDietPlanDetailActivity.setWeekTwoDataListenr(this)
    ...
    override fun getWeekTwoData(allWeekData: ShowWorkoutDetailModel.Data.GetProgramWorkouts) {
        weekPlanList.clear()
        val weekTwoDataArray = allWeekData.Week2

        if (weekTwoDataArray != null) {
            for (i in weekTwoDataArray.indices) {
                val weekDataObject = weekTwoDataArray.get(i)
    ...
    override fun changeStatus(data: WorkOutListModal.Data, pos: Int, status : String) {
        ...
        if("UpdateStatus".equals(status)){
            ...
            intent.putExtra("from_which_frament", "FromWeekTwo")
