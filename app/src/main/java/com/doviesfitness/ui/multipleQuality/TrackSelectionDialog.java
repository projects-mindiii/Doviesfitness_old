...
public final class TrackSelectionDialog extends DialogFragment {
  ...
  public static TrackSelectionDialog createForTrackSelector(
    ...
    trackSelectionDialog.init(/* titleId= */ R.string.track_selection_title, mappedTrackInfo,/* initialParameters = */ parameters,/* allowAdaptiveSelections =*/ true,
...
*/
  ...
  public  void showFragment(int qualityContainer, Context activity) {
    Fragment newFragment = tabFragments.get(0);
    getFragmentManager().beginTransaction().add(qualityContainer,newFragment,"").commit();
   // fragmentTransaction.ad
    //ft.add(qualityContainer, newFragment).commit();
  }
