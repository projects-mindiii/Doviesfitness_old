...
import com.doviesfitness.databinding.FragmentExerciseLibraryCreateBinding
...
private const val ARG_PARAM2 = "forReplace"
private const val ARG_PARAM3 = "exerciseType"
private const val ARG_PARAM4 = "isAddingInRound"

class ExerciseLibraryCreateWorkout : BaseFragment(), ExerciseLibraryAdapter.OnItemCLick {
    ...
    public lateinit var binding: FragmentExerciseLibraryCreateBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            isAddingInRound = it.getString(ARG_PARAM4)!!
            exerciseType = it.getString(ARG_PARAM3)!!
            forReplace = it.getString(ARG_PARAM2)!!

            Log.d("sldgdlsgkdsgdgs", "onCreate: exerciseType $exerciseType  forReplace $forReplace isAddingInRound $isAddingInRound")
        }
    }
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_exercise_library_create, container, false)
    ...
    private fun initialization() {
        ...
        binding.excericesMain.setOnScrollChangeListener(NestedScrollView.OnScrollChangeListener { v, scrollX, scrollY, oldScrollX, oldScrollY ->
    ...
    override fun onItemClick(exercise_category_id: String, display_name: String) {
        ...
        activity!!.startActivityForResult(Intent(mContext, ExerciseDetailListActivityNew::class.java)
            ...
            .putExtra("singleItemChange", singleItemChange)
            .putExtra("isAddingInRound", isAddingInRound)
            .putExtra("create", param1), resultCode
        )
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(param1: String, forReplace: String?,exerciseType: String?,isAddingInRound: String?) =
            ExerciseLibraryCreateWorkout().apply {
                arguments = Bundle().apply {
                    putString(ARG_PARAM1, param1)
                    putString(ARG_PARAM2, forReplace)
                    putString(ARG_PARAM3, exerciseType)
                    putString(ARG_PARAM4, isAddingInRound)
                }
            }
    }
