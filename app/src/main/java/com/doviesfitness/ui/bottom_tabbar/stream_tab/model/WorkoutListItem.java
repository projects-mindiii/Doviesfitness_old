...
public class WorkoutListItem{
	...
	@SerializedName("stream_workout_description")
	private String streamWorkoutDescription;
	...
	public void setStreamWorkoutDescription(String streamWorkoutDescription){
		this.streamWorkoutDescription = streamWorkoutDescription;
	}

	public String getStreamWorkoutDescription(){
		return streamWorkoutDescription;
	}
