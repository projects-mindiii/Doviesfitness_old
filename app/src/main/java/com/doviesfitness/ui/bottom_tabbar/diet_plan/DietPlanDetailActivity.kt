...
class DietPlanDetailActivity :BaseActivity(), View.OnClickListener,
    ...
    lateinit var binding: FragmentDietPcategoryDetailBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.fragment_diet_pcategory_detail)
        initialization()
    ...
    private fun initialization() {
        ...
        dietPlanSubCatgory=  intent.getParcelableExtra<DietPlanCateGoriesModal.Data.DietPlanCategory>("data")!!
     ...
     //   adddietPLanCategoryList = arguments!!.getParcelableArrayList<DietPlanSubCategoryModal.Data.DietListing>("addDietPlanList")
     ...
     //   binding.dpSubCategoryRv.addItemDecoration(ItemOffsetDecoration(getActivity(), R.dimen._10sdp))

        adapter = DietPalnSubCategoryAdapter(getActivity(), dietPSubCategoryList, this, isAdmin)
