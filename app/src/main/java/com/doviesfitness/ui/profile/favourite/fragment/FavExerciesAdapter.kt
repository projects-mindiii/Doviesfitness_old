...
class FavExerciesAdapter(context: Context, exerciseListing: ArrayList<FavExerciseModel.Data>, listener: OnItemClick, videowidth: Int, from:String) : androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder>() {
    private var context: Context;
    private var exerciseListing = ArrayList<FavExerciseModel.Data>()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): androidx.recyclerview.widget.RecyclerView.ViewHolder {
        ...
        when (viewType) {
            VIEWTYPE_ITEM -> {
                return MyViewHolder(LayoutInflater.from(context).inflate(R.layout.fav_exercies_view, parent, false))
            }
            else -> {
                return FooterLoader(
            ...
            * */
            ...
            if (Doviesfitness.getDataManager().getUserStringData(AppPreferencesHelper.PREF_KEY_APP_IS_ADMIN)!!.equals("Yes")) {
                ...
                if (exercise.exercise_access_level.equals("OPEN")) {
                    ...
                    context.startActivity(Intent(context, SubscriptionActivity::class.java).putExtra("home","no"))
                }
            }
        }
    ...
    public interface OnItemClick {
        fun videoPlayClick(isScroll: Boolean, data: FavExerciseModel.Data, position: Int, view: MyViewHolder, isLoad:Boolean)
        fun videoPlayClick(isScroll: Boolean, data: WorkoutExercise, position: Int, view: WorkoutAdapter.MyViewHolder)
        fun shareURL(data: FavExerciseModel.Data)
        fun setFavUnfavForExercies(data: FavExerciseModel.Data, position: Int, view: ImageView)
        fun setFavUnfavForFavExercies(data: WorkoutExercise, position: Int, view: ImageView)
        fun setSelected(position: Int, isSelected: Boolean, exercise: FavExerciseModel.Data)
    }
