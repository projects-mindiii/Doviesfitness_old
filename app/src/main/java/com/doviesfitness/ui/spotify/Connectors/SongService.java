package com.doviesfitness.ui.spotify.Connectors;
...
import com.doviesfitness.ui.spotify.VolleyCallBack;
...
public class SongService {
    ...
    public ArrayList<Song> getPlaylistTracks(final VolleyCallBack callBack) {
       // String endpoint = "https://api.spotify.com/v1/me/player/playlists";
      //  String endpoint = "https://api.spotify.com/v1/me/player/playlist-read-private";
      // String endpoint = "https://api.spotify.com/v1/users/"+userid+"/playlists";
    //  String endpoint = "https://api.spotify.com/v1/me/playlists";
   //   String endpoint = "https:\\/\\/api.spotify.com\\/v1\\/playlists\\/0s3VQEj2DnKfnpl0whQ6FK\\/tracks";
      String endpoint = "https://api.spotify.com/v1/playlists/"+"0s3VQEj2DnKfnpl0whQ6FK"+"/tracks";
      //  String  endpoint = "https://api.spotify.com/v1/tracks/"+userid;

      //  endpoint = "https://api.spotify.com/v1/tracks/0s3VQEj2DnKfnpl0whQ6FK";
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.GET, endpoint, null, response -> {
                    Gson gson = new Gson();
                    JSONArray jsonArray = response.optJSONArray("items");
                    ...
                    }//https:\/\/api.spotify.com\/v1\/playlists\/0s3VQEj2DnKfnpl0whQ6FK\/tracks
                    callBack.onSuccess();
                }, error -> {
                    // TODO: Handle error
