...
import java.util.*
import com.doviesfitness.databinding.FragmentWeekTwoBinding
...
class WeekTwoFragment : BaseFragment(), WeekAdapter.WeekListener,  CreateWorkOutPlanActivty.WeekTwoLinstenr {
    ...
    private lateinit var binding: FragmentWeekTwoBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_week_two, container, false)
        initialization()
        return binding.root
    }
    ...
    private fun initialization() {
        ...
        binding.week2Rv.addItemDecoration(DietPlanFragment.MySpacesItemDecoration(spacingInPixels1))
        ...
        adapter = WeekAdapter(binding.week2Rv.context, weekPlanList, this)
        val layoutManager1 = androidx.recyclerview.widget.LinearLayoutManager(context)
        binding.week2Rv.layoutManager = layoutManager1
        binding.week2Rv.adapter = adapter
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (createWorkOutPlanActivty != null) {
            createWorkOutPlanActivty.setWeekTwoDataListenr(this)
        }
    }
    ...
    override fun getWeekTwoData(allWeekData: ShowWorkoutDetailModel.Data.GetProgramWorkouts) {

        val weekOneDataArray = allWeekData.Week2
