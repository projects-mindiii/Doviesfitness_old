...
class PlanCategoryAdapter(var fm: androidx.fragment.app.FragmentManager, var fragments:List<androidx.fragment.app.Fragment>) : androidx.fragment.app.FragmentPagerAdapter(fm) {
