...
import com.doviesfitness.databinding.FragmentWeekFourBinding
...
class WeekFourFragment : BaseFragment(), WeekAdapter.WeekListener,
    CreateWorkOutPlanActivty.WeekFourLinstenr {
    ...
    private lateinit var binding: FragmentWeekFourBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_week_four, container, false)
        initialization()
        return binding.root
    }
    ...
    private fun initialization() {
        ...
        binding.week4Rv.addItemDecoration(DietPlanFragment.MySpacesItemDecoration(spacingInPixels1))
        ...
        adapter = WeekAdapter(binding.week4Rv.context, weekPlanList, this)
        val layoutManager1 = androidx.recyclerview.widget.LinearLayoutManager(context)
        binding.week4Rv.layoutManager = layoutManager1
        binding.week4Rv.adapter = adapter
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (createWorkOutPlanActivty != null) {
            createWorkOutPlanActivty.setWeekFourDataListenr(this)
        }
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 101 && data != null) {
            ...
            if (parentFragment is PagerWorkOutPlanFragment) {
                (parentFragment as PagerWorkOutPlanFragment).setWeekFourData(weekPlanList)
            }
        }
    }

    override fun getWeekFourData(allWeekData: ShowWorkoutDetailModel.Data.GetProgramWorkouts) {

        val weekOneDataArray = allWeekData.Week4
