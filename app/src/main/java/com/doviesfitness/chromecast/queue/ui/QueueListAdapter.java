...
package com.doviesfitness.chromecast.queue.ui;
...
import com.doviesfitness.chromecast.queue.QueueDataProvider;
...
public class QueueListAdapter extends RecyclerView.Adapter<QueueListAdapter.QueueItemViewHolder>
    ...
    private static final int PLAY_RESOURCE = R.drawable.play_ico;
    private static final int PAUSE_RESOURCE = R.drawable.exo_icon_pause;
    private static final int DRAG_HANDLER_DARK_RESOURCE = R.drawable.black_arrow_ico;
    private static final int DRAG_HANDLER_LIGHT_RESOURCE = R.drawable.ic_left_arrow;
    ...
    /* package */ static class QueueItemViewHolder extends RecyclerView.ViewHolder implements
        ...
        private void updateControlsStatus(@ControlStatus int status) {
            int bgResId = R.drawable.transparent_reps_bg;
            ...
            switch (status) {
                case CURRENT:
                    bgResId = R.drawable.green_btn_bg;
