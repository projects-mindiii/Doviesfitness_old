...
public class FragmentMyDietPlanBindingImpl extends FragmentMyDietPlanBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.my_dp_main, 2);
        sViewsWithIds.put(R.id.my_dp_rv, 3);
        sViewsWithIds.put(R.id.no_dietPlan_found, 4);
        sViewsWithIds.put(R.id.dumble, 5);
        sViewsWithIds.put(R.id.txt_add_plan, 6);
        sViewsWithIds.put(R.id.txt_description, 7);
        sViewsWithIds.put(R.id.btn_add_dietPlan, 8);
        ...
        sViewsWithIds.put(R.id.lineView, 15);
    }
    // views
    // variables
    // values
    ...
    public FragmentMyDietPlanBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 16, sIncludes, sViewsWithIds));
    }
    private FragmentMyDietPlanBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
