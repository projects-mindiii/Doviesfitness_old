...
public class ActivityInboxBindingImpl extends ActivityInboxBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.my_inbox_main, 2);
        sViewsWithIds.put(R.id.my_inbox_rv, 3);
        sViewsWithIds.put(R.id.no_inbox_found, 4);
        ...
        sViewsWithIds.put(R.id.dp_title_name, 12);
    ...
    public ActivityInboxBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 17, sIncludes, sViewsWithIds));
    }
    private ActivityInboxBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
