...
public class FragmentMyFavouriteBindingImpl extends FragmentMyFavouriteBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.dp_title_name, 4);
        sViewsWithIds.put(R.id.devider_view, 5);
        sViewsWithIds.put(R.id.fav_tablayout, 6);
        sViewsWithIds.put(R.id.fav_view_pager, 7);
    }
    // views
    // variables
    // values
    ...
    public FragmentMyFavouriteBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private FragmentMyFavouriteBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
